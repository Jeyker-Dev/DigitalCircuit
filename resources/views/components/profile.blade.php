...
<div x-data="{ open: false }">
    <div class="flex items-center mr-8" role="button" @click="open = !open">
        ...
        <div>
            <svg :class="open ? 'rotate-360' : 'rotate-0'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="icon icon-tabler icons-tabler-filled icon-tabler-arrow-badge-down text-gray-800 dark:text-gray-200 h-6 w-6 {{$svgClass}}"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M16.375 6.22l-4.375 3.498l-4.375 -3.5a1 1 0 0 0 -1.625 .782v6a1 1 0 0 0 .375 .78l5 4a1 1 0 0 0 1.25 0l5 -4a1 1 0 0 0 .375 -.78v-6a1 1 0 0 0 -1.625 -.78z" /></svg>
        </div>
    </div>
        ...
        <div x-show="open" @click.away="open = false" class="dropdown-profile bg-base-100 rounded-box z-[1] shadow bg-white dark:bg-sky-900 border border-sky-600 w-52 h-52 mr-4 flex flex-col">
            ...
            <a href="{{route('myprofile.show')}}" class="text-gray-800 dark:text-gray-200 hover:text-sky-400 dark:hover:text-sky-400 transition duration-500 ease-in-out w-8/12 p-2 ml-2 my-1">
                ...
                <a href="#" class="text-gray-800 dark:text-gray-200 text-lg font-open-sans font-medium hover:text-sky-400 dark:hover:text-sky-400 transition duration-500 ease-in-out w-8/12 p-2 ml-2">
                    <div class="flex items-center">
                ...
                <div class="mt-14 border-t-[1px] border-sky-600 w-full">
                    <form method="POST" action="{{route("logout")}}">
                        ...
                        <a href="{{ route("logout") }}" class="text-gray-800 dark:text-gray-200 text-lg font-open-sans font-medium hover:text-sky-400 dark:hover:text-sky-400 transition duration-500 ease-in-out w-8/12 p-2" onclick="event.preventDefault();
